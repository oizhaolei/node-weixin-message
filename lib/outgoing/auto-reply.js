...
module.exports = {
  _xml: function(from, to, type, data) {
    if (['text', 'image', 'voice', 'video', 'news', 'music', 'transfer_customer_service'].indexOf(type) !== -1) {
  ...
  transfer_customer_service: function(from, to) {
    return this._xml(from, to, 'transfer_customer_service', {
    });
  },
